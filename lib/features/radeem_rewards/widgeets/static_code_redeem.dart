...
import 'package:organization/features/radeem_rewards/widgeets/apply_widget.dart';
  ...
  Widget build(BuildContext context) {
    return  Center(
      child: Column(children: [
        Text(
            "Enter Redeem Code",style: AppTextStyle.headlineLStyle.copyWith(fontWeight: FontWeight.w600)),
