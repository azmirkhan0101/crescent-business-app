...
class AndroidSubscriptionScreen extends StatefulWidget {
  const AndroidSubscriptionScreen({super.key});

  @override
  State<AndroidSubscriptionScreen> createState() => _AndroidSubscriptionScreenState();
}

class _AndroidSubscriptionScreenState extends State<AndroidSubscriptionScreen> {
  // Selected plan (0 = Free, 1 = 6 Months)
  int selectedPlan = 0;

  final AndroidSubscriptionController controller = Get.find<AndroidSubscriptionController>();
