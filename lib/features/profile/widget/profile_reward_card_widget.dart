...
class ProfileRewardCardWidget extends StatelessWidget {
  const ProfileRewardCardWidget({
    super.key, required this.topIcon, required this.title, required this.subtitle, required this.bottomIcon1, required this.bottomIcon2, required this.bottomText,
  });
      ...
      children: [
        ...
        Text(
          maxLines: 1,
            overflow: TextOverflow.ellipsis,
            subtitle,
            style:AppTextStyle.mediumStyle.copyWith(fontSize: 11.sp,color: Color(0xFF848484))
        ),
        SizedBox(height: 10.h,),
        Text(
            bottomText,
